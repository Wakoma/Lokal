...
in `admin_password` variable.

You can upgrade wordpress either by settings `wordpress_version` to higher value
...
by setting variable `wordpress_version` to the correct value. See the default value
