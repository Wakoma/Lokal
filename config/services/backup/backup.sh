...
dc exec -T mariadb mysqldump -u root -p${MYSQL_ROOT_PASSWORD} --routines --triggers ${MYSQL_DATABASE_WORDPRESS} | gzip -9 > ${THIS_BACKUP_DIR}/${TIMESTAMP}.mysql.dump.sql.gzip
